...
Reusable React components. `components/ui/` holds the Mochi primitives. The feature folders (`bingo/`, `games/`, `room/`) build Playroom from them.
...
| Folder                  | Contents                                                                                                      |
| ----------------------- | ------------------------------------------------------------------------------------------------------------- |
| `components/ui/`        | Mochi primitives: `Button`, `Card`, `Input`, `Avatar`, `Face`, `Speech`, `Sticker`, `Chip`, `RoomKeyDisplay`. |
