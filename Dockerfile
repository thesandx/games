...
ARG NEXT_PUBLIC_PLAYROOM_API_URL=https://api.sandeep.app/games/v1
ARG NEXT_PUBLIC_PLAYROOM_TRANSPORT=local
ENV NEXT_PUBLIC_APP_URL=${NEXT_PUBLIC_APP_URL}
ENV NEXT_PUBLIC_APP_NAME=${NEXT_PUBLIC_APP_NAME}
ENV NEXT_PUBLIC_APP_VERSION=${NEXT_PUBLIC_APP_VERSION}
ENV NEXT_PUBLIC_PLAYROOM_API_URL=${NEXT_PUBLIC_PLAYROOM_API_URL}
ENV NEXT_PUBLIC_PLAYROOM_TRANSPORT=${NEXT_PUBLIC_PLAYROOM_TRANSPORT}
